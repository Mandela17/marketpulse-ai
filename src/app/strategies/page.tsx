...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    winRate: '65–72%',
    riskReward: '1:2',
    description: 'The ultimate quality filter: promoter-backed (>65%) AND MF-validated (>10%), with positive returns across ALL timeframes — 6M, 1Y, 5Y, and All-Time. True compounders.',
    rules: [
  ...
  },
  {
    ...
    winRate: '68–75%',
    riskReward: '1:2.5',
    description: 'Like Evergreen but uses 10-Year return. Promoter-backed (>65%) AND MF-validated (>10%), with positive returns across 6M, 1Y, 5Y, and 10Y.',
    rules: [
      'Promoter Holding > 65% (founder conviction)',
      'Mutual Fund Holding > 10% (institutional stamp)',
      '6-Month Return positive',
